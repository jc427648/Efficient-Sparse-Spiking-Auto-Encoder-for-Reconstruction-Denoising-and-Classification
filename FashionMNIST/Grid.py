...
def run(
    ...
    string1 = 'W1_Ap%.2eAn%.2eTp%.2eTn%.2ebt1%.2edc1%.2einc1%.2lat%.2eNH%iIT%i.svg' %(
        Ap1,
        An1,
        TauP1,
        TauN1,
    ...
    string2 = 'W2_Ap%.2eAn%fTp%.2eTn%.2ebt1%.2edc1%.2einc1%.2elat%iNH%iIT%i.svg' %(
        Ap2,
        An2,
        TauP2,
        TauN2,
...
if __name__ == "__main__":
    ...
    parser.add_argument("--decay2",type = float,default = 0)
    parser.add_argument("--increase1",type=float,default = 1e0)
    parser.add_argument("--increase2",type = float, default = 0)
    parser.add_argument("--Ap1",type = float, default = 0.12)
    parser.add_argument("--Ap2",type = float,default = 0.9)#0.0005
    parser.add_argument("--An1",type = float,default = 0.06)
    parser.add_argument("--An2",type = float,default = 0.02)
    parser.add_argument("--TauP1", type = float,default = 40)
    parser.add_argument("--TauP2",type = float,default = 30)
    parser.add_argument("--TauN1",type = float, default = 200)
    parser.add_argument("--TauN2",type = float,default = 1000)
    ...
    parser.add_argument("--Ap3",type = float,default = 0.32)
    parser.add_argument("--An3", type = float, default = 0.06)
    ...
    parser.add_argument("--lif1_scale",type = float, default = 0.99)
